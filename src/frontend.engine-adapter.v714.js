...
if(!G) throw new Error('GameEngine Phase 4 Core 未加载');
...
global.GameUIEngine=Object.freeze({
  ...
  simNewGame,simGetLegalActions,applyAction,computeCost,getReachableMovePaths,resolveAI,deriveSeed,mulberry32
});
})(window);
